...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var g = new bootstrap.Modal(document.getElementById("event-modal"), {keyboard: !1}),
        ...
        l = document.getElementById("form-event"), v = null, p = document.getElementsByClassName("needs-validation"),
        e = new Date, t = e.getDate(), n = e.getMonth(), e = e.getFullYear(), a = FullCalendar.Draggable,
        d = document.getElementById("external-events"),
        y = [{id: 1, title: "World Braille Day", start: "2022-01-04", className: "bg-info-subtle", allDay: !0}, {
            id: 2,
    ...
    b.render(), upcomingEvent(y), l.addEventListener("submit", function (e) {
        ...
        var t, n, e = document.getElementById("event-title").value, a = document.getElementById("event-category").value,
            ...
            l = new Date(d[1]), l = (l.setDate(l.getDate() + 1), d[1] ? l : ""), o = null,
            r = document.getElementById("event-location").value, c = document.getElementById("event-description").value,
            s = document.getElementById("eventid").value, m = !1,
